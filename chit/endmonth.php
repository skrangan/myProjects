...
<hr>
Click here to start the Month End process <form action=monthend1.php method=POST><input type=hidden value=end name=new><input type=submit value="Month end continue.."></form><hr>
<?php //Click here to start the New Month process <form action=monthend1.php method=POST><input type=hidden value=start name=new><input type=submit value=NewMonth></form>
?></fieldset>
<h3>site info</h3>

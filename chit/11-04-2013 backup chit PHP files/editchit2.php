...
if($nval==$cval)
{
  $sql="update addchit set cvalue='$cval' where cname='$cname'";
  mysql_query($sql);
  $sql="insert into mchit values('$cname','$cval','$date')";
  mysql_query($sql);
  echo "<h3 color=blue>Value Changed Successfully...</h3>";
...
{
echo "<h3 color=red> Value could not be changed</h3>";
}
?>

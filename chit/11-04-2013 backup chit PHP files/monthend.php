...
<hr>
Click here to start the Month End process <form action=monthend1.php method=POST><input type=hidden value=end name=new><input type=submit value=MonthEnd></form><hr>

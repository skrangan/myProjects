...
<br>
<hr>
Click the delete button near the Chit to change..<br><br>
<?php
...
while($row=mysql_fetch_array($k))
{
  ...
  echo "<td><form action=delchit1.php method=POST><input type=hidden value=".$row['cname']." name=cname><input type=submit value=delete></form></tr>";
}echo "</table>";
?>
<br>
<h4>NOTE:</h4>The Chit delete is independent of Month transaction..<br>
<h3>site info</h3>

...
else
{
  ...
  $tot1=0;$tot=0;
  echo "<table border='1'>
  <tr><th>ID</th><th>Name</th><th>Proffession</th><th>Mobile</th><th>email</th><th>Date</th><th>Select</th></tr>";
  ...
  echo "<td>".$row['date']."</td>";
  echo "<td><form action=delusr2.php method=POST><input type=hidden name=id value=".$row['id'].">"; ?> <input type=submit value=Delete onclick="return confirm('Are you sure?');"></form></td></tr>";
 <?php
 } 

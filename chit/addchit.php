...
<h1>Chit Addition</h1>
<h3>Select a chit</h3>
<form action="chitadd.php" method="POST">
<table style="padding:5px;width:250px;border:0">
<tr><td>Chit Name</td><td><input type="text" name="cname" required="required" placeholder="Chit Name"></td></tr>
<tr><td>Chit Value</td><td><input type="text" name="cvalue" required="required" placeholder="Chit Value"></td></tr>
...
<tr><td></td><td><input type="submit" value="submit"><input type="reset" value="reset"></tr>
</table>
</form>
<h3>site info</h3>

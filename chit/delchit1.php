...
echo "<tr><td>Chit Added date</td><td>".$date."</td></tr>";
echo "<form action=delchit2.php method=POST><input type=hidden value=".$cname." name=cname>";
?>
<tr><td>Select date</td><td><SELECT NAME="jmonth">
...
<h4>NOTE:</h4>The Chit Deletion is independent of Month transaction..<br>
<h3>site info</h3>
